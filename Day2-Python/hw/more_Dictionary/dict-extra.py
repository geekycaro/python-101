providers = iter(["Level3", "Verisign", "Google", "Quad9", "DNS.WATCH",
...
ips = iter(["209.244.0.3", "64.6.64.6", "8.8.8.8", "9.9.9.9", "84.200.69.80",
...
provider_mapping = list(zip(providers,ips))
for mapping, address in provider_mapping:
